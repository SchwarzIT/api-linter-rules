...
const ruleset = {
  ...
  rules: {
    ...
    'channel-event-key-subscribe-validation': channelEventKeySubscribeValidation,
    'channel-event-parameters-are-defined-if-set': channelEventParametersAreDefinedIfSet,
    ...
    'x-scope-operations-parameter-restrictions-has-valid-parameter': xScopeOperationsParameterRestrictionsHasValidParameter,
    'x-scope-operations-parameter-restrictions-has-enum-or-const': xScopeOperationsParameterRestrictionsHasEnumOrConst,
    'x-scope-operations-parameter-restrictions-const-single-value': xScopeOperationsParameterRestrictionsConstSingleValue,
